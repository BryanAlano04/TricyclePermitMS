          ...
          <div class="col-lg-10" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="faq-container">
              ...
              <div class="faq-item faq-active">
                <h3>How do I apply for a tricycle permit?</h3>
                <div class="faq-content">
                  <p>Simply visit our online platform and fill out the application form. Upload the required documents, and submit your application for review.</p>
                </div>
              ...
              <div class="faq-item">
                ...
                <div class="faq-content">
                  <p>Your application will be reviewed by the BPLO staff. If additional information or documents are needed, you will be notified. Once approved, your permit will be added to the list of issued permits.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Who can I contact for help with my application?</h3>
                <div class="faq-content">
                  <p>If you need assistance, you can contact our support team through the 'Contact Us' section on our website, or visit the BPLO office for in-person support.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>How long does the permit approval process take?</h3>
                <div class="faq-content">
                  <p>The review and approval process typically takes a few days, depending on the completeness of your application and the current workload of the BPLO staff.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Is my personal information safe on your platform?</h3>
                <div class="faq-content">
                  <p>Yes, we prioritize the security of your personal information. Our system uses advanced encryption and security measures to protect your data.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->

              <div class="faq-item">
                <h3>Can I update my application after submission?</h3>
                <div class="faq-content">
                  <p>If you need to make changes to your application, please contact our support team. They will guide you on how to proceed with updating your information.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
