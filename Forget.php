    ...
    if (mysqli_num_rows(mysqli_query($conx, "SELECT * FROM user WHERE email='{$email}'")) > 0) {
        ...
        if ($query) {
            ...
            try {
                ...
                $mail->Body    = '<p> This is the Verifecation Link<b><a href="http://localhost/TricyclePermitMS/change-Password.php?Reset=' . $CodeReset . '">"http://localhost/TricyclePermitMS/change-Password.php?Reset=' . $CodeReset . '"</a></b></p>';
